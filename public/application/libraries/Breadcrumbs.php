	...
	function show()
	{
		if ($this->breadcrumbs) {
			...
			foreach ($this->breadcrumbs as $key => $crumb) {
				...
				if (end($keys) == $key) {
					$output .= $this->crumb_last_open . '<span itemprop="name">' . $crumb['page'] . '</span>' . $this->crumb_close;
				} else {
					$output .= $this->crumb_open.'<a  itemprop="item" href="' . $crumb['href'] . '"> <span itemprop="name">' . $crumb['page'] . '</span></a> '.$this->crumb_close;
				}
			}
